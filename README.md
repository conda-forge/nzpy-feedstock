About nzpy-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nzpy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14544&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nzpy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nzpy` can be installed with `conda`:
...
It is possible to list all of the versions of `nzpy` available on your platform with `conda`:
...
```
mamba search nzpy --channel conda-forge
```
...
mamba repoquery search nzpy --channel conda-forge

# List packages depending on `nzpy`:
mamba repoquery whoneeds nzpy --channel conda-forge

# List dependencies of `nzpy`:
mamba repoquery depends nzpy --channel conda-forge
```
